...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/6006d0d0f6b9000015a3168a
...
To start editing your site, you can use the Sanity interface at https://neat-sparrow-6d0d0.sanity.studio/.
...
Generated at `2021-01-19T12:30:22.410Z` by Stackbit version `0.3.43`.